...
class HdKeyPairTest {
    ...
    void test1() {
        ...
        assertFalse(hdKeyPair.isHardened);
        assertEquals("m/0'/1/2'/2/1000000000", hdKeyPair.path);
    }

    @Test
    void test2() {
        byte[] input = new BigInteger("fffcf9f6f3f0edeae7e4e1dedbd8d5d2cfccc9c6c3c0bdbab7b4b1aeaba8a5a29f9c999693"
        ...
        // m/0/2147483647h/1
        HdKeyPair hdKey3_2 = hdKey2.generateChild(11, false);
        ...
        xpub = "xpub6DF8uhdarytz3FWdA8TvFSvvAh8dP3283MY7p2V4SeE2wyWmG5mg5EwVvmdMVCQcoNJxGoWaU9DCWh89LojfZ537wTf"
                + "unKau47EL2dhHKon";
        assertNotEquals(xprv, hdKey3_2.serialize(true));
        assertEquals(xprv, hdKey3.serialize(true));
        assertNotEquals(xpub, hdKey3_2.serialize(false));
    ...
    @Test
    void test3() {
        byte[] input = new BigInteger("4b381541583be4423346c643850da4b320e46a87ae3d2a4e6da11eba819cd4acba45d23931"
    ...
    void test4() {
        ...
        assertThrows(UnsupportedOperationException.class, () -> hdKeyPair2.generateChild(-9, true));
        assertThrows(NullPointerException.class, () -> hdKeyPair2.generateChild(null));
        assertThrows(KeyException.class, () -> hdKeyPair2.generateChild("k0"));
    ...
    void deserializeTest() {
        ...
        String xdrv = "xdrv9s21ZrQH143K3QTDL4LXw2F7HEK3wJUD2nW2nRk4stbPy6cq3jPPqjiChkVvvNKmPGJxWUtg6LnF5kejMRNN"
                + "U3TGtRBeJgk33yuGBxrMPHi";
        assertThrows(KeyException.class, () -> HdKeyPair.deserialize(xdrv));
        ...
        assertThrows(KeyException.class, () -> HdKeyPair.deserialize(xpub));
        ...
        assertThrows(KeyException.class, () -> HdKeyPair.deserialize(checksum));
    }
