...
class KeyPairTest {
    ...
    void d() {
        ...
        assertThrows(KeyException.class, () -> new KeyPair(BigInteger.valueOf(-1), true));
        assertThrows(KeyException.class, () -> new KeyPair(Ecc.secp256k1.getN(), false));
        assertThrows(KeyException.class, () -> new KeyPair(new BigInteger(new byte[32]), true));
