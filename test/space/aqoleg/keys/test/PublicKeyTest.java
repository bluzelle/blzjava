...
class PublicKeyTest {
    ...
    void test2() {
        ...
        assertThrows(KeyException.class, () -> PublicKey.createFromBytes(bytes0));
        ...
        assertThrows(EccException.class, () -> PublicKey.createFromBytes(bytes1));
        ...
        assertThrows(KeyException.class, () -> PublicKey.createFromBytes(bytes2));

        byte[] bytes3 = Converter.hexToBytes("086339cd653f9678e7ecda450054d51594b1e4655728a9cf2791b68cadb189f34c");
        assertThrows(KeyException.class, () -> PublicKey.createFromBytes(bytes3));
